...
<body>
    <div>
        <header>
            <nav class="navbar navbar-light bg-light justify-content-between">
                <a class="navbar-brand" href="index.php">Интернет Библиотека</a>
            </nav>
        </header>
    ...
    <h3>Задание №1: Вставка в таблицу author</h3>
                ...
                <h3>Задание №2: Редактирование записи в таблице author по ID</h3>
